...
class trees
{
    //THIS PART IS FOR HEIGHT OF A TREE
    ...
    //THIS PART OF CODE IS TO COUNT NODES NUMBER
    public static int numberOfNodes(Node root){
        if(root==null) return 0;
        return 1+numberOfNodes(root.left)+numberOfNodes(root.right);
    }
    
    //THIS PART OF CODE IS TO CHECK VALUE IS PRESENT OR NOT
    ...
    //THIS PART OF CODE IS TO COUNT NUMBER OF LEAF NODES
    ...
    //THIS PART OF CODE IS TO TELL NUMBER OF NODES PRESENT AT A LEVEL
    ...
    //THIS PART OF CODE IS TO FIND SUM OF NODES
